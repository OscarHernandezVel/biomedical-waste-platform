...
import com.biomedical.waste.demo.services.admin.FlotaTransporteAdminService;
...
@RestController
@RequestMapping("/api/admin/flota_transporte")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class FlotaTransporteAdminController {
    private final FlotaTransporteAdminService service;
