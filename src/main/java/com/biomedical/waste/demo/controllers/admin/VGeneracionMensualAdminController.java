...
import com.biomedical.waste.demo.services.admin.VGeneracionMensualAdminService;
...
@RestController
@RequestMapping("/api/admin/v_generacion_mensual")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class VGeneracionMensualAdminController {
    private final VGeneracionMensualAdminService service;
