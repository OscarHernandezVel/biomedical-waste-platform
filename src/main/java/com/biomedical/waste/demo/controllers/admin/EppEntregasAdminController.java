...
import com.biomedical.waste.demo.services.admin.EppEntregasAdminService;
...
@RestController
@RequestMapping("/api/admin/epp_entregas")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class EppEntregasAdminController {
    private final EppEntregasAdminService service;
