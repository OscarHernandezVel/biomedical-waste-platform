...
import com.biomedical.waste.demo.services.admin.CatalogoTipoInstalacionesAdminService;
...
@RestController
@RequestMapping("/api/admin/catalogo_tipo_instalaciones")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class CatalogoTipoInstalacionesAdminController {
    private final CatalogoTipoInstalacionesAdminService service;
