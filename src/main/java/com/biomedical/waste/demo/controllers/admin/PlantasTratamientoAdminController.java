...
import com.biomedical.waste.demo.services.admin.PlantasTratamientoAdminService;
...
@RestController
@RequestMapping("/api/admin/plantas_tratamiento")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class PlantasTratamientoAdminController {
    private final PlantasTratamientoAdminService service;
