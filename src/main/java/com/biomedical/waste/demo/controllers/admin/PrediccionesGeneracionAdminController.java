...
import com.biomedical.waste.demo.services.admin.PrediccionesGeneracionAdminService;
...
@RestController
@RequestMapping("/api/admin/predicciones_generacion")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class PrediccionesGeneracionAdminController {
    private final PrediccionesGeneracionAdminService service;
