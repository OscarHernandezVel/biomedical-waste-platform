...
import com.biomedical.waste.demo.services.admin.ClientesInstalacionesAdminService;
...
@RestController
@RequestMapping("/api/admin/clientes_instalaciones")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class ClientesInstalacionesAdminController {
    private final ClientesInstalacionesAdminService service;
