...
import com.biomedical.waste.demo.services.admin.TarifasMercadoAdminService;
...
@RestController
@RequestMapping("/api/admin/tarifas_mercado")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class TarifasMercadoAdminController {
    private final TarifasMercadoAdminService service;
