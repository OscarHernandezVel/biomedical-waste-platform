...
import com.biomedical.waste.demo.services.admin.EjecucionesRutaAdminService;
...
@RestController
@RequestMapping("/api/admin/ejecuciones_ruta")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class EjecucionesRutaAdminController {
    private final EjecucionesRutaAdminService service;
