...
import com.biomedical.waste.demo.services.admin.DisposicionFinalAdminService;
...
@RestController
@RequestMapping("/api/admin/disposicion_final")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class DisposicionFinalAdminController {
    private final DisposicionFinalAdminService service;
