...
import com.biomedical.waste.demo.services.admin.CatalogoTipoResiduoAdminService;
...
@RestController
@RequestMapping("/api/admin/catalogo_tipo_residuo")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class CatalogoTipoResiduoAdminController {
    private final CatalogoTipoResiduoAdminService service;
