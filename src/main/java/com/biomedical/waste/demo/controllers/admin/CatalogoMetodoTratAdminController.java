...
import com.biomedical.waste.demo.services.admin.CatalogoMetodoTratAdminService;
...
@RestController
@RequestMapping("/api/admin/catalogo_metodo_tratamiento")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class CatalogoMetodoTratAdminController {
    private final CatalogoMetodoTratAdminService service;
