...
import com.biomedical.waste.demo.services.admin.HistoricoGeneracionAdminService;
...
@RestController
@RequestMapping("/api/admin/historico_generacion")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class HistoricoGeneracionAdminController {
    private final HistoricoGeneracionAdminService service;
