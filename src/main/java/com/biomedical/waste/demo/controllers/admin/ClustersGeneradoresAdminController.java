...
import com.biomedical.waste.demo.services.admin.ClustersGeneradoresAdminService;
...
@RestController
@RequestMapping("/api/admin/clusters_generadores")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class ClustersGeneradoresAdminController {
    private final ClustersGeneradoresAdminService service;
