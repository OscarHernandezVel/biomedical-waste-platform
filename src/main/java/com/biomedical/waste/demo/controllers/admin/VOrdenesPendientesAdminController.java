...
import com.biomedical.waste.demo.services.admin.VOrdenesPendientesAdminService;
...
@RestController
@RequestMapping("/api/admin/v_ordenes_pendientes")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class VOrdenesPendientesAdminController {
    private final VOrdenesPendientesAdminService service;
