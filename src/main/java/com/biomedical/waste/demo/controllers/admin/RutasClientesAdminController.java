...
import com.biomedical.waste.demo.services.admin.RutasClientesAdminService;
...
@RestController
@RequestMapping("/api/admin/rutas_clientes")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class RutasClientesAdminController {
    private final RutasClientesAdminService service;
