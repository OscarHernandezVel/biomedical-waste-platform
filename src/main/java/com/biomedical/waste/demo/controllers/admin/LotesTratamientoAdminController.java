...
import com.biomedical.waste.demo.services.admin.LotesTratamientoAdminService;
...
@RestController
@RequestMapping("/api/admin/lotes_tratamiento")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class LotesTratamientoAdminController {
    private final LotesTratamientoAdminService service;
