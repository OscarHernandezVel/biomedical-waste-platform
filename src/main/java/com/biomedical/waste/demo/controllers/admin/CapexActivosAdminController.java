...
import com.biomedical.waste.demo.services.admin.CapexActivosAdminService;
...
@RestController
@RequestMapping("/api/admin/capex_activos")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class CapexActivosAdminController {
    private final CapexActivosAdminService service;
