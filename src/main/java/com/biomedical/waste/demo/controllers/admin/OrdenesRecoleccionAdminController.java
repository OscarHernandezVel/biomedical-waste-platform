...
import com.biomedical.waste.demo.services.admin.OrdenesRecoleccionAdminService;
...
@RestController
@RequestMapping("/api/admin/ordenes_recoleccion")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class OrdenesRecoleccionAdminController {
    private final OrdenesRecoleccionAdminService service;
