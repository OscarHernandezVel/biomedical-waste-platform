...
import com.biomedical.waste.demo.services.admin.OrdenesLotesAdminService;
...
@RestController
@RequestMapping("/api/admin/ordenes_lotes")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class OrdenesLotesAdminController {
    private final OrdenesLotesAdminService service;
