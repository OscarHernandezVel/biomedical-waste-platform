...
import com.biomedical.waste.demo.services.admin.ClustersClientesAdminService;
...
@RestController
@RequestMapping("/api/admin/clusters_clientes")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class ClustersClientesAdminController {
    private final ClustersClientesAdminService service;
