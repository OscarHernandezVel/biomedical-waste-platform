...
import com.biomedical.waste.demo.services.admin.VEstadoFlotaAdminService;
...
@RestController
@RequestMapping("/api/admin/v_estado_flota")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class VEstadoFlotaAdminController {
    private final VEstadoFlotaAdminService service;
